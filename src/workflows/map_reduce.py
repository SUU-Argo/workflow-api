...
def count_words(line_object: dict):
    import json
    from collections import defaultdict

    print("Received object: {object}!".format(object=line_object))
    # Output the content of the "value" key in the line_object
    value = line_object["value"]
    words = value.split()
